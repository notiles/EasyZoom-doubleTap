...
(function (root, factory) {
    ...
    EasyZoom.prototype._init = function() {
        ...
        this.$target.on({
            ...
            'mouseleave.easyzoom': $.proxy(this._onLeave, this),
            'dblclick.easyzoom': $.proxy(this._onEnter, this),
            'touchstart.easyzoom': $.proxy(this._onDoubleTap, this)
        });
    ...
    EasyZoom.prototype._setTapedTwice = function() {
        this.tapedTwice = false;
    };

    EasyZoom.prototype._onDoubleTap = function(e) {
        
            this.show(e);
            if(!this.tapedTwice) {
                this.tapedTwice = true;
                var self = this;
                setTimeout( function (){self.tapedTwice = false;}, 300 );
                return false;
            }
    ...
    EasyZoom.prototype._onEnter = function(e) {
        ...
        if (!touches || touches.length == 1) {
            e.preventDefault();
            this.show(e, true);
            document.querySelector('.productView-images').classList.add('show-zoom');
        }
    };
    ...
    EasyZoom.prototype._onLeave = function() {
        ...
        document.querySelector('.productView-images').classList.remove('show-zoom');
    };
